...
public interface UserFacade {
     ...
     * @throws com.technical.credit.common.exception.ModelNotFoundException - if user not found by username
     */
     ...
     * @return required user.
     * @throws com.technical.credit.common.exception.ModelNotFoundException - if user not found by id
     */
